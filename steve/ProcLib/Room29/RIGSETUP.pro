...
declare constant hide int 	Room			= 29;

// viewing measurements used to compute degrees (units need to be the same)
declare constant hide float Scr_width   	= 375.0; // in some units
declare constant hide float Scr_height  	= 275.0; // in some units
declare 		 hide float Subj_dist   	= 570.0; // distance from center of subjects eyeball to screen
...
declare constant hide float	Refresh_rate	= 60;	// in Hz
