...
process CMD_PGS(int curr_target, 																// set SETC_TRL.pro
	...
	spawnwait DRW_RECT(pd_size*3.5,pd_size,pd_angleR,pd_eccentricity,15,fill,unit2pix_X,unit2pix_Y);			// draw photodiode marker
	spawnwait DRW_RECT(pd_size*3.5,pd_size,pd_angleL,pd_eccentricity,15,fill,unit2pix_X,unit2pix_Y);			// draw photodiode marker
    nexttick;
